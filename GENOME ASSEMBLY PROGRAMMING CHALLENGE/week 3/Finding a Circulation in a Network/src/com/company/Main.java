...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Circulation.FlowGraph graph = new Circulation.FlowGraph(numVertices);
...
class Circulation {
    ...
    protected static class FlowGraph {
        int[] flowMap;
        int flowResult = 0;
        List<Edge> edges;
        List[] graph;
    ...
    protected static void findCirculation(FlowGraph graph, int numVertices, int numEdges) {
